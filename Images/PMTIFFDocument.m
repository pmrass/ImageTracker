classdef PMTIFFDocument
    ...
    %   Detailed explanation goes here
        ...
        function [MetaData] =                    ExtractLSMMetaData(obj)
                    ...
                    metaDataObject =            PMMetaData(lsmData.DimensionY, lsmData.DimensionX, lsmData.DimensionZ, lsmData.DimensionTime, ...
                        lsmData.DimensionChannels, lsmData.VoxelSizeX, lsmData.VoxelSizeY, lsmData.VoxelSizeZ, ...
                        lsmData.TimeStamp);
        ...
        function [MetaData]=        ExtractMetaDataFromOMEContent(obj, ParsedOMEMetaData)
                    ...
                    ListWithAbsoluteTimeStamps_Sec=                                 cell2mat(cellfun(@(x) datenum(x)*3600*24, ListWithDates_Reformatted, 'UniformOutput', false));
                     ...
                     metaDataObject =            PMMetaData(NumberOfRows,NumberOfColumns, NumberOfPlanes, NumberOfFrames, ...
                        NumberOfChannels, VoxelSizeX, VoxelSizeY, VoxelSizeZ, ...
        ...
        function [CellMapContents, CellMapTitles] =                                 ExtractFieldsForImageReading(obj, CurrentDirectory, FrameNumber, PlaneNumber, varargin)
            ...
            % this is different for each image type, but output needs to be identical double check with other image types that output is the same;
