classdef PMMovieLibrary
    ...
    % also has ListWithLoadedImageData that saves previously loaded image data, useful when switching between different movies to avoid reloading data repeatedly from file;
    ...
    methods % SETTERS MOVIE-LIST SET MOVIETRACKING FROM FILE;
         ...
         function obj =      updateMovieListWithMovieController(obj, ActiveMovieController)
            ...
            try
                ...
                obj =                           obj.updateMovieIndexWith(SelectedRow, ActiveMovieController.getLoadedMovie);
    ...
    methods % GETTERS: MOVIECONTROLLER
        ...
        function myMovieController =        getActiveMovieController(obj, varargin)
            ...
            % returns a PMMovieController object with the following properties:
            % the movie-controller is set from scratch and comes with movie-specific properties;
            % PMovieTracking set from file or loaded from memory;
            % if any image-volumes were already stored in PMMovieLibrary, these images will be set on the PMMovieController;
            ...
            switch length(varargin)
                ...
                case 0
                   myMovieTracking = obj.getActiveMovieTracking;
                case 1
            ...
            if isempty(Input)
                 ...
                 myMovieTracking =     myMovieTracking.setLoadedImageVolumes(Input); 
            end
            
            
            myMovieController =     PMMovieController(myMovieTracking);
    ...
    methods (Access = private)
           ...
           function myMovieTracking=           getActiveMovieTracking(obj, varargin)
            ...
            % if the movie was NOT loaded before: loads data from file;
            % if the movie WAS already loaded: simply get previously loaded MovieTracking from memory;
    ...
    methods % GETTERS: MOVIE-TRACKING
    ...
    methods % SETTERS FILTER 
        ...
        function FilterSelectionIndex =         getFilterSelectionIndex(obj)
            % called by PMImagingProjectViewer/updateWith
    ...
    methods (Access = private) % SETTERS MOVIELIST: updateMovieIndexWith;
        ...
        function obj =      updateMovieIndexWith(obj, SelectedRow, MyLoadedMovie)
            ...
            obj.ListWithLoadedImageData{SelectedRow,1} =        MyLoadedMovie.getLoadedImageVolumes;
